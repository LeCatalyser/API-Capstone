...
const state = {
  //single source of truth/the brain of the operation
  items: [
    {
      name: "Rosa Parks",
      warnings: [
...
$("body").on("click", "button.choice-item-toggle", function provideAnswer(
  event
) {
...
/////////////// API CODE   ////////////////
var wikipedia_base_URL =
  "https://crossorigin.me/https://en.wikipedia.org/w/api.php";
...
var testGetPageId = function() {
  ...
  if (pageId === "25568315") {
    ...
    console.log(
      `ERROR: getPageId returned ${JSON.stringify(pageId)} instead of "25568315"`
    );
  }
};
